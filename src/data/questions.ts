...
export const questionSlugs = ['what-is-coding-plan', 'cheapest-coding-plan', 'best-coding-plan'] as const
...
export const whatIsCodingPlan = defineContentPage({
  ...
  seo: {
    ...
    canonical: 'https://codingplan.org/questions/what-is-coding-plan',
    locale: 'zh-CN',
    ogType: 'article',
  },
  hero: {
  ...
  related: [
    { kind: '选型', title: '哪家 Coding Plan 最便宜？', description: '按起步价与单位成本排序。', href: '/questions/cheapest-coding-plan' },
    { kind: '选型', title: 'Coding Plan 哪个好？怎么选', description: '按场景的推荐结论。', href: '/questions/best-coding-plan' },
    { kind: '对比', title: 'GLM vs Kimi 怎么选', description: '两家额度口径差异详解。', href: '/compare/glm-vs-kimi' },
  ],
})
...
export const cheapestCodingPlan = defineContentPage({
  ...
  seo: {
    ...
    canonical: 'https://codingplan.org/questions/cheapest-coding-plan',
    locale: 'zh-CN',
    ogType: 'article',
  },
  hero: {
  ...
  related: [
    ...
    { kind: '选型', title: 'Coding Plan 哪个好？怎么选', description: '不差钱视角的推荐排行。', href: '/questions/best-coding-plan' },
    { kind: '百科', title: 'Coding Plan 是什么？', description: '先弄懂额度口径再比价。', href: '/questions/what-is-coding-plan' },
  ],
})
...
export const bestCodingPlan = defineContentPage({
  ...
  seo: {
    ...
    canonical: 'https://codingplan.org/questions/best-coding-plan',
    locale: 'zh-CN',
    ogType: 'article',
  },
  hero: {
  ...
  related: [
    { kind: '对比', title: 'GLM vs Kimi 怎么选', description: '两大热门的正面对比。', href: '/compare/glm-vs-kimi' },
    { kind: '选型', title: '哪家 Coding Plan 最便宜？', description: '价格优先视角的排行。', href: '/questions/cheapest-coding-plan' },
