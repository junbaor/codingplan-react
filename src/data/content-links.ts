...
const zhCommon: Record<string, RelatedLink> = {
  ...
  whatIs: { kind: '百科', title: 'Coding Plan 是什么？', description: '从 Token API 到订阅制套餐的概念、额度口径与适用人群。', href: '/blogs/what-is-coding-plan' },
  cheapest: { kind: '选型', title: '哪家 Coding Plan 最便宜？', description: '按起步价与单位额度成本排序的省钱结论。', href: '/blogs/cheapest-coding-plan' },
  best: { kind: '选型', title: 'Coding Plan 哪个好？怎么选', description: '按使用强度、模型偏好与工具生态给出推荐结论。', href: '/blogs/best-coding-plan' },
  glmVsKimi: { kind: '对比', title: 'GLM vs Kimi：两家 Coding Plan 怎么选', description: '价格、模型、额度口径与工具支持逐项对比。', href: '/blogs/glm-vs-kimi' },
