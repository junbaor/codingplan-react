...
const zhipu = definePlan({
  ...
  seo: { title: '智谱 GLM Coding Plan 详解 - GLM-5.3 新旗舰上线，连续包月 ¥118 起，每周积分制', description: '智谱 GLM Coding Plan 套餐详解：Lite ¥118/月、Pro ¥538/月、Max ¥1078/月，连续包季 8 折 / 包年 7 折；每周 Credits 制度（Lite 10,000 / Pro 60,000 / Max 140,000 Credits）；GLM-5.3（8/14 发布）已上线全量用户，Terminal-Bench 3.0 开源第一。', canonical: 'https://codingplan.org/plans/zhipu', locale: 'zh-CN', ogType: 'article' },
  hero: { badge: '智谱 AI · GLM Coding Plan', title: '智谱 GLM', highlight: 'Coding Plan', description: 'GLM-5.3（2026/8/14 发布）已上线 Coding Plan 全量用户：Terminal-Bench 3.0 开源第一，编程体感较 5.2 再提升 50%。套餐为连续包月价 + 每周 Credits 制度，连包季 8 折、包年 7 折，现已恢复开放订阅。', stats: [{ value: '3', label: '套餐档位' }, { value: '¥118', label: '起步价/月' }, { value: '140K', label: 'Max 每周 Credits' }, { value: '20+', label: '支持工具' }] },
  modelsTitle: '模型介绍', modelsDescription: 'GLM-5.3 新旗舰（8/14 发布）+ GLM-5.2 上一代旗舰，全系逐步向各档位开放。',
  models: [
    { icon: '🚀', name: 'GLM-5.3', description: '最新旗舰模型（8/14 发布并上线全量用户）。基座与 5.2 相同，靠后训练 Scaling 将编程体感再提升 50%：Terminal-Bench 3.0 开源第一（4.6→28.3）、DeepSWE v1.1 达 66.9，还涌现网络安全攻防能力。权重两周内开源（MIT）。', badge: '新旗舰 · Terminal-Bench 开源第一' },
    { icon: '🌟', name: 'GLM-5.2', description: '上一代旗舰（6/13 全量开放），发布即获 LMArena 代码榜开源第一、全球第二（仅次于 Claude Fable 5）。支持 1M 上下文，面向长程代码工程。' },
  ...
  faqs: [
    ...
    { question: 'GLM Coding Plan 支持哪些模型？', answer: '支持 GLM-5.3（8/14 发布并上线全量用户，Terminal-Bench 3.0 开源第一）、GLM-5.2（LMArena 代码榜开源第一，1M 上下文）、GLM-5.1、GLM-5-Turbo 和 GLM-4.7。新旗舰按 Max 首发接入、Pro 优先体验、Lite 逐步开放的节奏放量。' },
    { question: 'GLM-5.3 相比 GLM-5.2 提升了什么？', answer: 'GLM-5.3 基座与 5.2 完全相同，提升全部来自后训练 Scaling：内部体感评测编程能力较 5.2 提升 50%，Terminal-Bench 3.0 从 4.6 跃升至 28.3（开源第一），DeepSWE v1.1 达 66.9，并涌现网络安全攻防能力。8/14 发布当天已上线全量用户并重置全员额度。' },
...
const kimi = definePlan({
  ...
  hero: { badge: 'Moonshot AI · Kimi Code Plan', title: 'Kimi', highlight: 'Code Plan', description: 'Kimi K3 已正式上线（2026/7/17 发布，2.8T 参数，1M 上下文），Moderato 起可使用 K3，Allegro 解锁 1M 超长对话。7/19 起因算力紧缺暂停 C 端新用户订阅，正随扩容逐步恢复。', stats: [{ value: '5', label: '套餐档位' }, { value: '¥49', label: '起步价/月' }, { value: 'K3', label: '正式上线' }, { value: '4+', label: '会员权益' }] },
  modelsTitle: '模型介绍', modelsDescription: 'Kimi K3 旗舰（2026/7/17 发布）+ K2.7 / K2.7 Code，新一代编程模型组合。', models: [
    ...
    { icon: '🌙', name: 'Kimi K2.7 / K2.7 Code', description: '上一代旗舰编程模型（K2.7 Code 为 Kimi CLI 默认模型，已被 GitHub Copilot 接入），Adagio/Andante 套餐默认可访问，Moderato 起与 K3 同享额度。' },
  ],
  plansTitle: '套餐详情', plansDescription: '5 档套餐覆盖入门到顶级 · Moderato 起可使用 K3 · 年付最高立省 ¥1,680。', purchaseUrl: 'https://www.kimi.com/code',
  plans: [
    { name: 'Adagio', badge: '免费', price: '¥0', unit: '/月', discount: '免费体验档 · 1 Agent 任务并行', features: ['Kimi K2.7 / K2 模型可访问', '1 Agent 任务并行 · 无优先生成队列', '2 个项目 · 500MB 存储', '2 个定时/小组件任务', 'AI 建站 / AI 文档 / AI PPT 权益', 'K3 模型不可用（需 Moderato 及以上）'], audience: '轻度试用用户、临时需求、想先体验 Kimi 生态的新用户', ctaLabel: '免费开通 Adagio →' },
    { name: 'Andante', badge: '基础', price: '¥49', unit: '/月', discount: '年付 ¥39/月（¥468/年）', features: ['约 300-1,200 API 调用/5h', '每 7 天刷新，未用完不累积', 'Kimi K2.7 / K2.7 Code 旗舰模型', '4 倍速度 Agent 优先生成队列', '20 个项目 · 20GB 存储', 'AI 建站 / AI 文档 / AI PPT 权益', 'K3 模型不可用（需 Moderato 及以上）'], audience: '个人开发者与编程办公一体化用户', ctaLabel: '立即购买 Andante →' },
  ...
  sections: [{ title: '会员权益', description: '不只是编程，还有更多 AI 能力。', cards: [
    { icon: '💻', title: 'Kimi Code', description: '使用 K3 / K2.7 进行代码生成、重构和调试。' },
  ...
  ] }, { title: 'K3 模型使用规则', headingLevel: 3, highlights: ['K3 模型仅 Moderato 及以上可用，Adagio/Andante 不可访问', 'Allegro 独家解锁 1M token 超长上下文', 'K3 与 K2.7 共享 5h 配额与 7 天刷新周期'] }, { title: '订阅状态提示', headingLevel: 3, warning: '7/19 起 Kimi 因算力紧缺暂停 C 端新用户订阅，已随扩容逐步恢复；后续新订阅将拆分为 Kimi 主权益与 Kimi Code 权益，购买前以官网当前入口为准。', highlights: ['已订阅用户全部权益不受影响', '新订阅名额随算力扩容逐步开放', '后续将拆分 Kimi 主权益 / Kimi Code 权益'] }],
  tools: ['Kimi CLI', 'Kimi Code for VS Code', 'Claude Code', 'Roo Code'],
  contentOrder: ['models', 'plans', 'section:0', 'tools', 'section:1', 'section:2', 'faq'],
  faqs: [
    { question: '五档套餐有什么区别？', answer: 'Adagio 免费可访问 K2.7；Andante（¥49）是付费入门档；Moderato（¥99）起可使用 K3；Allegretto（¥199）增加 Agent 集群 40 次/月与目标模式；Allegro（¥699）独家解锁 1M 超长上下文与 4 Agent 并行。' },
    { question: 'K3 和 K2.7 怎么选？', answer: 'K3 是 2026/7/17 发布的 2.8T 参数旗舰，支持 100 万 token 上下文，原生视觉能力；K2.7 / K2.7 Code 仍是稳定主力（K2.7 Code 是 Kimi CLI 默认模型）。K3 仅 Moderato 及以上可用，Adagio/Andante 仍可使用 K2.7。' },
    { question: '现在还能订阅吗？', answer: '7/19 起 Kimi 因 K3 发布后请求量暴涨、算力紧缺，暂停了 C 端新用户订阅；官方正全速扩容并逐步开放名额，后续新订阅将拆分为 Kimi 主权益与 Kimi Code 权益。已订阅用户权益不受影响，购买前请以官网当前状态为准。' },
...
const volcengine = definePlan({
  ...
  seo: { title: '火山引擎方舟 Coding Plan 详解 - 限时 9.9 元起 · 加量不加价，8+ 款模型自由切换', description: '火山引擎方舟 Coding Plan Lite/Pro 套餐，支持豆包、DeepSeek、Kimi、GLM、MiniMax 等 8+ 款模型自由切换（GLM-5.2 / Doubao-Seed-2.1-turbo / Kimi-K3 / Kimi-K2.7-Code / MiniMax-M3 / Deepseek-V4），Auto 模式智能调度，限时 9.9 元起，GLM-5.2 等热门模型限时加量 4 倍。', canonical: 'https://codingplan.org/plans/volcengine', locale: 'zh-CN', ogType: 'article' },
  hero: { badge: '火山引擎 · 方舟 Coding Plan', title: '火山引擎方舟', highlight: 'Coding Plan', description: '8+ 款模型自由切换 / Auto 模式智能调度；限时 9.9 元起 · 加量不加价，GLM-5.2 / Doubao-Seed-2.1-turbo / Kimi-K3 / Kimi-K2.7-Code / MiniMax-M3 / Deepseek-V4 全在列。', stats: [{ value: '8+', label: '可用模型' }, { value: '¥9.9', label: '首购起价' }, { value: '2', label: '套餐档位' }, { value: 'Auto', label: '智能调度' }] },
  modelsTitle: '模型阵容', modelsDescription: '已接入 Doubao-Seed-2.1-turbo、Kimi-K3、Kimi-K2.7-Code、MiniMax-M3、Deepseek-V4 系列；GLM-5.2 等热门模型限时加量 4 倍。', models: [
    ...
    { icon: '🌙', name: 'Kimi-K3', description: 'Moonshot AI 最新旗舰编程模型（2.8T 参数，1M 上下文），新接入。', badge: '新接入' },
    { icon: '🌗', name: 'Kimi-K2.7 / K2.7-Code', description: 'Moonshot AI 上一代旗舰与代码专用版（K2.7-Code 已被 GitHub Copilot 接入）。' },
    { icon: '🔷', name: 'GLM-5.2', description: '智谱上一代旗舰模型，支持 1M 上下文，限时加量 4 倍。', badge: '限时加量 4 倍' },
...
const aliyun = definePlan({
  slug: 'aliyun', accent: 'orange', availability: 'active',
  seo: { title: '阿里云百炼 Token Plan 详解 - Qwen3.8-Max 首发，早鸟 ¥39/月起 Credits 制', description: '阿里云百炼 Token Plan（原 Coding Plan 全面升级）：个人版 Lite ¥39/月、Standard ¥139/月、Pro ¥499/月（早鸟价），Credits 按 5 小时 + 7 天双窗口刷新；Qwen3.8-Max 首发尝鲜，新增 DeepSeek-V4-Pro、HappyHorse1.1，覆盖 Qwen/DeepSeek/GLM/Wan 多模态模型。', canonical: 'https://codingplan.org/plans/aliyun', locale: 'zh-CN', ogType: 'article' },
  hero: { badge: '阿里云百炼 · Token Plan', title: '阿里云百炼', highlight: 'Token Plan', description: 'Coding Plan 已全面升级为 Token Plan：Credits 计量、多模态旗舰共享额度，Qwen3.8-Max（2.4T）首发尝鲜；个人版早鸟 ¥39/月起，另有团队版席位。', stats: [{ value: '¥39', label: '早鸟月付' }, { value: '10+', label: '模型' }, { value: '12,000', label: 'Pro Credits/5h' }, { value: '8', label: 'Agent 并发（Pro）' }] },
  modelsTitle: '模型阵容', modelsDescription: 'Qwen3.8-Max 首发尝鲜，新增 DeepSeek-V4-Pro 与 HappyHorse1.1，Qwen / DeepSeek / GLM / Wan / HappyHorse 多模态共享 Credits。', models: [
    { icon: '☁️', name: 'Qwen3.8-Max', description: '阿里 2.4T 参数新一代旗舰（预览版），Token Plan 首发尝鲜，限时白天 Credits 1 折。', badge: '首发尝鲜' },
    { icon: '🧠', name: 'DeepSeek-V4-Pro', description: 'DeepSeek 旗舰开源模型，新接入。', badge: '新接入' },
    { icon: '⌨️', name: 'qwen3.7-plus / qwen3.7-max', description: '千问 3.7 系列多模态通用与推理旗舰。' },
    { icon: '🖥️', name: 'qwen3-coder 系列', description: '面向软件工程的代码模型。' },
    { icon: '🎨', name: 'HappyHorse1.1 / Wan 系列', description: '视觉生成与图像视频模型，与文本共享 Credits。', badge: '限时 6 折' },
    { icon: '🔷', name: 'GLM 系列', description: '智谱旗舰模型。' },
  ],
  plansTitle: '个人版套餐', plansDescription: '早鸟限时价（ Lite 6.5 折 / Standard 7.7 折 / Pro 8.3 折），Credits 按 5 小时 + 每 7 天双窗口刷新；另有团队版席位（¥150/席/月起）。', purchaseUrl: 'https://www.aliyun.com/benefit/scene/codingplan?source=5176.29345612&userCode=j0hv8tuh',
  plans: [
    { name: 'Lite', badge: '早鸟 ¥39/月', price: '¥39', unit: '/月', discount: '早鸟 6.5 折（原价 ¥60/月）', features: ['700 Credits/5h · 2,500 Credits/7天', '1-2 个 Agent 并发', '全模态模型共享额度', '夜间使用更优惠'], audience: '轻度使用与尝鲜用户' },
    { name: 'Standard', badge: '推荐', price: '¥139', unit: '/月', discount: '早鸟 7.7 折（原价 ¥180/月）· 4× Lite 用量', features: ['3,000 Credits/5h · 10,000 Credits/7天', '3-4 个 Agent 并发', 'Lite 全部权益', '夜间使用更优惠'], audience: '日常开发的主力档位', featured: true },
    { name: 'Pro', badge: '重度畅用', price: '¥499', unit: '/月', discount: '早鸟 8.3 折（原价 ¥600/月）· 16× Lite 用量', features: ['12,000 Credits/5h · 40,000 Credits/7天', '6-8 个 Agent 并发', 'Standard 全部权益', '夜间使用更优惠'], audience: '高频、大型项目和专业开发者' },
  ],
  comparison: { title: '套餐横向对比', description: '早鸟限时价与双窗口 Credits 额度，实际消耗取决于模型 Credits 倍率。', columns: ['套餐', '早鸟月付', '原价', 'Credits/5h', 'Credits/7天', 'Agent 并发'], featuredColumn: 2, rows: [['Lite', '¥39', '¥60', '700', '2,500', '1-2'], ['Standard', '¥139', '¥180', '3,000', '10,000', '3-4'], ['Pro', '¥499', '¥600', '12,000', '40,000', '6-8']] },
  sections: [{ title: '额度与接入规则', warning: '早鸟价为限时优惠，Qwen3.8-Max 限时白天 Credits 1 折，活动以官网为准。', cards: [
    { title: '专属 API Key', description: '套餐提供 sk-sp- 开头的专属 API Key 与 Base URL，通用百炼 Key 不抵扣额度。' },
    { title: 'Credits 双窗口', description: '5 小时滚动窗口 + 每 7 天刷新，任一窗口耗尽即暂停，分别按周期恢复。' },
    { title: '夜间更优惠', description: '夜间时段 Credits 抵扣更低，重度任务可挪到夜间跑。' },
    { title: '数据不训练', description: '计划内调用承诺不用于模型训练。' },
  ] }, { title: '旧 Coding Plan 去向', headingLevel: 3, highlights: ['按次数计费的 Coding Plan（Lite ¥40 / Pro ¥200）已升级为 Credits 计量的 Token Plan', '旧 Lite 此前已停售，Pro 每日 9:30 限量补货的模式不再适用', '老用户按官方指引迁移，历史额度口径以订单页为准'] }],
  tools: ['Qoder', 'Qwen Code', 'Claude Code', 'Cursor', 'Cline', 'Roo Code', 'OpenCode'],
  contentOrder: ['models', 'plans', 'section:0', 'comparison', 'section:1', 'faq'],
  faqs: [
    { question: 'Token Plan 和原来的 Coding Plan 是什么关系？', answer: '阿里云百炼已将按次数计费的 Coding Plan 全面升级为 Credits 计量的 Token Plan：模型从 Qwen3.5 扩展到 Qwen3.8-Max（首发）+ DeepSeek-V4-Pro 等多模态旗舰，额度从「次数」改为按模型倍率抵扣的 Credits，并新增个人版/团队版双版本。' },
    { question: '个人版三档怎么选？', answer: 'Lite ¥39/月（700 Credits/5h）适合轻度；Standard ¥139/月（3,000 Credits/5h，4× Lite）是日常主力；Pro ¥499/月（12,000 Credits/5h，16× Lite）面向重度与多 Agent 并发。均为早鸟限时价。' },
    { question: 'Credits 是怎么消耗的？', answer: '不同模型有不同的 Credits 倍率，调用时按倍率从 5 小时与 7 天双窗口扣减；Qwen3.8-Max 限时白天 1 折，夜间时段抵扣更低。' },
    { question: '还有团队版吗？', answer: '有。团队版按席位订阅：标准席位 ¥150/席/月、高级席位 ¥550/席/月、尊享席位 ¥1,398/席/月（早鸟价），适合企业统一管理。' },
    { question: '旧的每日 9:30 补货还有吗？', answer: '不再适用。旧 Coding Plan Pro 的限量补货模式已随产品升级取消，Token Plan 可直接订阅。' },
