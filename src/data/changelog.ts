...
export const changelogPage = defineContentPage({
  ...
  related: [
    ...
    { kind: '选型', title: '哪家 Coding Plan 最便宜？', description: '涨价潮之后的最新入门价排序。', href: '/questions/cheapest-coding-plan' },
    { kind: '对比', title: 'GLM vs Kimi 怎么选', description: '两家调价后的价格与额度口径对比。', href: '/compare/glm-vs-kimi' },
  ],
})
