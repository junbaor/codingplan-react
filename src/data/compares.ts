 ...
 * [OUTPUT]: 对外提供 /blogs/glm-vs-kimi 与 /en/blogs/claude-vs-glm 双语对比文章数据
...
export const glmVsKimi = defineContentPage({
  ...
  seo: {
    ...
    description: '智谱 GLM Coding Plan 与 Kimi Code Plan 逐项对比：入门价（¥118/¥94.4 年付 vs ¥49/¥39 年付）、模型（GLM-5.3/5.2 vs K3/K2.7）、额度口径（每周 Credits vs 5h+7 天）、MCP 工具与年付折扣，附按人群的选购结论。',
    canonical: 'https://codingplan.org/blogs/glm-vs-kimi',
    locale: 'zh-CN',
    ogType: 'article',
  },
  hero: {
    ...
    description: '两家 2026 年都完成了旗舰更新与价格重排：GLM-5.3（8/14 发布）接棒 5.2 登顶 Terminal-Bench 开源榜，K3 以 2.8T 参数 + 1M 上下文正式上线。核心差异在额度口径与档位设计。',
    stats: [
      { value: '¥94.4 vs ¥39', label: '年付入门月价' },
      { value: 'GLM-5.3 vs K3', label: '旗舰模型' },
  ...
  sections: [
    {
      ...
      table: {
        ...
        rows: [
          ...
          ['旗舰模型', 'GLM-5.3（8/14 发布，Terminal-Bench 3.0 开源第一）', 'Kimi K3（2.8T 参数，1M 上下文，Moderato 起可用）'],
          ['模型数量', '5 款（GLM-5.3/5.2/5.1/5-Turbo/4.7）', 'K3 + K2.7 双档（免费档 K2/K2.7）'],
    ...
    },
    {
      title: '选 GLM 的理由',
      cards: [
        { icon: '🏆', title: '开源第一的 GLM 旗舰', description: 'GLM-5.3（8/14 上线全量用户）Terminal-Bench 3.0 开源第一，前代 5.2 曾登顶 LMArena 代码榜；1M 上下文全量开放。' },
    ...
    },
    {
      title: '选 Kimi 的理由',
      cards: [
        { icon: '💸', title: '更低的入门价', description: '免费档 Adagio 可用 K2.7，Andante 年付 ¥39/月即入门，试错成本远低于 GLM Lite（注意 7/19 起新订阅暂停、逐步恢复中）。' },
    ...
    },
    {
      ...
      highlights: [
        ...
        '要最强开源模型 + MCP：GLM Pro（年付 ¥430.4/月），GLM-5.3/5.2 + 精选 MCP 工具集',
  ...
  faqs: [
    ...
    { question: 'GLM-5.3 和 Kimi K3 哪个写代码更强？', answer: 'GLM-5.3（8/14 发布）Terminal-Bench 3.0 开源第一（28.3）、DeepSWE v1.1 达 66.9，前代 5.2 曾在 LMArena 代码榜开源第一；K3 参数量 2.8T、支持 1M 上下文，在 SWE-Bench 等评测中接近 Anthropic 前沿水平。综合工程能力 GLM 略占优，超长上下文场景 K3 独有 1M 优势。' },
    { question: '两家可以同时订阅吗？', answer: '可以，且不少开发者这么做：Kimi 低档位承担轻量与长上下文任务，GLM Pro 档承担主力工程出码（注意 Kimi 7/19 起新订阅暂停、逐步恢复中）。两家都支持 Claude Code 接入，切换成本低。' },
  ...
  related: [
    ...
    { kind: '教程', title: 'Claude Code 配置智谱 GLM', description: '环境变量与端点配置指南。', href: '/blogs/claude-code-with-glm' },
...
export const claudeVsGlm = defineContentPage({
  ...
  seo: {
    ...
    description: 'Claude Code (Anthropic) vs GLM Coding Plan (Z.ai) compared: Pro $20 vs Lite $18, Opus 4.7 vs GLM-5.3, usage multipliers vs weekly Credits, MCP support and annual discounts — with clear recommendations per use case.',
    canonical: 'https://codingplan.org/en/blogs/claude-vs-glm',
    locale: 'en',
    ogType: 'article',
  },
  hero: {
    ...
    description: 'Claude Code is the gold standard for AI coding; GLM undercuts it by 10% at entry level with GLM-5.3 (new flagship since Aug 14, #1 open-source on Terminal-Bench 3.0) and GLM-5.2 (#1 on LMArena Code). Here is how they stack up in 2026.',
    stats: [
      { value: '$20 vs $18', label: 'Entry price / month' },
      { value: 'Opus 4.7 vs GLM-5.3', label: 'Flagship models' },
  ...
  sections: [
    ...
    },
    {
      ...
      cards: [
        ...
        { icon: '📏', title: '1M context', description: 'GLM-5.2/5.3 offer up to 1M-token context — beyond Claude standard limits.' },
      ],
    },
    {
      ...
      highlights: [
        ...
        'Very large codebases: GLM 1M context',
  ...
  faqs: [
    ...
    { question: 'Is GLM-5.3 as good as Claude Opus 4.7 for coding?', answer: 'GLM-5.3 (released Aug 14) tops Terminal-Bench 3.0 among open models and its predecessor 5.2 ranked #1 open-source and #2 globally on LMArena Code, just behind Claude. Opus 4.7 still leads on complex agentic tasks, but the gap has narrowed considerably for everyday coding.' },
