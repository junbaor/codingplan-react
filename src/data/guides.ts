 ...
 * [OUTPUT]: 对外提供 Claude Code × 国产 Coding Plan 配置教程文章数据（GLM/Kimi/火山方舟，挂载于 /blogs）
...
[Environment]::SetEnvironmentVariable("ANTHROPIC_AUTH_TOKEN", "你的智谱 API Key", "User")`,
  ...
  related: [
    ...
    { kind: '对比', title: 'GLM vs Kimi 怎么选', description: '两家旗舰模型与额度口径对比。', href: '/blogs/glm-vs-kimi' },
    { kind: '教程', title: 'Claude Code 配置 Kimi Code Plan', description: '另一家低价套餐的接入教程。', href: '/blogs/claude-code-with-kimi' },
...
export const claudeCodeWithKimi = defineContentPage({
  ...
  seo: {
    ...
    canonical: 'https://codingplan.org/blogs/claude-code-with-kimi',
    locale: 'zh-CN',
    ogType: 'article',
  },
  hero: {
...
/model`,
  ...
  related: [
    ...
    { kind: '对比', title: 'GLM vs Kimi 怎么选', description: '两家价格与额度口径对比。', href: '/blogs/glm-vs-kimi' },
    { kind: '教程', title: 'Claude Code 配置智谱 GLM', description: '另一家热门套餐接入教程。', href: '/blogs/claude-code-with-glm' },
  ],
})
...
/model   # 选择 Doubao / GLM / Kimi / MiniMax / DeepSeek 或 Auto`,
  ...
  related: [
    ...
    { kind: '教程', title: 'Claude Code 配置智谱 GLM', description: '单模型深度使用场景的替代方案。', href: '/blogs/claude-code-with-glm' },
  ],
})
